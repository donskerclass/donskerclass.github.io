...
![Do they Fit?](Figures/MeeseRogoffAbstract.png){height=300px}   
...
- Form of these bounds (eg Yu (1994), Mohri et al (2009, 2018)) is: for any $p\in\mathcal{P}$ with probability at least $1-\delta$,
...
- Generalization error bounds are upper bounds
    ...
    - Generalization error sometimes still very small also for models with very high complexity
        - Active research area on "benign overfitting" and "double descent" on when and why this happens ([Hardt & Recht 2021 Ch 6](https://mlstory.org/generalization.html))
